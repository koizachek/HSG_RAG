...
class ChatbotCLI:
    ...
    def _print_welcome_message(self) -> None:
        ...
        console.print(
            Panel(
                "[bold green]University of St. Gallen Executive Education Chatbot[/bold green]\n\n"
                "Welcome! I'm your Executive Education Advisor. Ask me about programs, "
                "admissions, costs, or anything related to executive education at the "
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            if query.lower() in ["exit", "quit", "bye", "goodbye"]:
                console.print("\n[bold green]Thank you for using the University of St. Gallen Executive Education Chatbot. Goodbye![/bold green]")
                break
