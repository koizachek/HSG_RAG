...
TEST_DEPENDENCIES = {
    ...
    "tests/test_transcript_logger.py": {"langchain_core", "langchain", "langsmith", "colorama"},
    "tests/test_usage_event_logger.py": {"colorama"},
    "tests/test_usage_turn_outcomes.py": {"langchain_core", "langchain", "langsmith", "colorama"},
