...
class TestLanguageLocking:
    ...
    def test_language_locked_after_first_message(self):
        ...
        response1 = agent.query("Hallo, ich interessiere mich für das EMBA Programm")
...
class TestUserAcceptanceScenarios:
    ...
    def test_tc_emba_01_german_speaker(self):
        ...
        response = agent.query("Welche Voraussetzungen brauche ich für das EMBA Programm?")
    ...
    def test_tc_emba_03_cost_inquiry(self):
        ...
        response = agent.query("Was kostet das EMBA Programm?")
...
class TestEdgeCases:
    ...
    def test_mixed_language_input(self):
        ...
        response = agent.query("Hello I want to know über das EMBA program")
    ...
    def test_special_characters(self):
        ...
        response = agent.query("Cost??? $$$ EMBA!!!!")
